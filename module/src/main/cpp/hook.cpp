...
#include <limits>
#include <thread>
#define GamePackageName OBFUSCATE("com.pixel.gun3d")
...
void Patches() {
  ...
  //  PATCH_SWITCH("0x305D3CC", "802580D2C0035FD6", cWear);
    ...
    PATCH("0x49AF408", "000080D2C0035FD6");//Swear filter search for fuck
            ...
            if (ImGui::BeginTabBar("Menu", tab_bar_flags)) {
                if (ImGui::BeginTabItem(OBFUSCATE("Account"))) {
                    ...
                    if (ImGui::CollapsingHeader(OBFUSCATE("Currency Mods"))) {
                        ImGui::SliderInt(OBFUSCATE("Amount"), &amountws, 0, 10000000);
                ...
                if (ImGui::BeginTabItem(OBFUSCATE("Weapon"))) {
                 ...
                 //   ImGui::Checkbox(OBFUSCATE("Fire-Rate"), &firerate);
                    ...
                    ImGui::SliderFloat(OBFUSCATE("Silent Aim Power"), &snowstormbullval, 0.0f,3000.0f);
